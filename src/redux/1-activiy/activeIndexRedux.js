...
export function getIndustry() {
	...
	return dispatch => {
		axios
			.post(serverIp + '/dianzanbao/config/getIndustry.do', data, {
				headers: {
...
export function getActiveList(activeParam, fn) {
	...
	return dispatch => {
		axios
			.post(serverIp + '/dianzanbao/active/getActiveList.do', data, {
				headers: {
					token: window.sessionStorage.getItem('token'),
					user_id: window.sessionStorage.getItem('user_id')
				}
...
export function getActiveInfo(id) {
	...
	return dispatch => {
		axios
			.post(serverIp + '/dianzanbao/active/getActiveDetail.do', data, {
				headers: {
					token: window.sessionStorage.getItem('token'),
					user_id: window.sessionStorage.getItem('user_id')
				}
