...
import {
	getRecentViewActive,
	getRecentViewBusiness,
	clearRecentViewActive,
	clearRecentViewBusiness
} from '../../../redux/4-myinfo/recentViewRedux'
...
class ActiveList extends React.Component {
	...
	getFirstPageData(type, fn) {
		...
		if (type === 'first') {
			this.props.getRecentViewActive(data)
		} else {
			this.props.getRecentViewActive(data, fn)
		}
	}
	...
	componentWillUnmount() {
		this.props.clearRecentViewActive()
	}
...
ActiveList = connect(
	state => state.recentView,
	{ getRecentViewActive, clearRecentViewActive }
)(ActiveList)
...
BusinessList = connect(
	state => state.recentView,
	{ getRecentViewBusiness, clearRecentViewBusiness }
)(BusinessList)
